...
papersize: a4
link-citations: yes
footer_contents: "FLCore 2.6.15 - What is new"
...
A release of the [FLCore](https://flr-project.org/FLCore) package is now on the FLR repository, with binary packages being made available for R version 4.0.0. What is new in the package being released? This is a brief introduction, including example code, of the main recent developments and changes.
...
- `readVPAInterCatch()` creates an FLQuant from a VPA file as exported by ICES Intercatch system.
